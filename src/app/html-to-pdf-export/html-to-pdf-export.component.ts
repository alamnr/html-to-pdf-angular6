...
@Component({
  selector: 'app-html-to-pdf-export',
  templateUrl: './html-to-pdf-export.component.html',
  styleUrls: ['./html-to-pdf-export.component.sass']
})
export class HtmlToPdfExportComponent implements OnInit {
